...
namespace QingShan.Web.Areas.Admin.Controllers
{
    ...
    public class UserController : AdminBaseController
    {
        ...
        [HttpGet]
        [Description("获取角色列表")]
        public async Task<PageOutputDto<QingShan.Services.Systems.Role.Dto.OutputDto.RoleOutputDto>> GetUserRoleData()
        {
            var result =  await _roleService.PageAsync(new Services.Systems.Role.Dto.InputDto.PageRoleInputDto() { Enabled = true, PageNo = 1, PageSize = 999 });
            return result;
        }
